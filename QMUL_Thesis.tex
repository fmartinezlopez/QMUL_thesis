...
% Copyright declaration (for SOTON)
%----------------------------------------------------------
\include{InitialFinalMaterials/Copyright}  
...
\include{Chapters/Appendix_Matched_Filter}
\include{Chapters/Appendix_DM_Analysis}
\include{Chapters/Appendix_GArSoft_PID}
