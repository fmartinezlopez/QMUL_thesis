...
allows to . The true neutrino energy distribution for the selected events can be recovered doing $\mathrm{TP}+\mathrm{FP}$, while the combination $\mathrm{TP}+\mathrm{FN}$ gives the true spectrum.
