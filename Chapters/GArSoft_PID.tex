...
I used the resulting most probable $\left<\mathrm{d}E/\mathrm{d}x\right>$ values and the centres of the $\beta\gamma$ bins as the points to fit to the ALEPH formula. The results are shown in Fig. \ref{fig:dEdx_betagamma_ALEPH} (top panel). The best fit parameters I found are summarised in Tab. \ref{tab:aleph_fit}. One can see that the obtained 
...
\textbf{Energy and Geometry ECAL}
\begin{itemize}
