...
I used the resulting most probable $\left<\mathrm{d}E/\mathrm{d}x\right>$ values and the centres of the $\beta\gamma$ bins as the points to fit to the ALEPH formula. The result is shown in Fig. \ref{fig:dEdx_betagamma_ALEPH} (top panel). The best fit parameters 
\begin{equation}
    \begin{split}
        P_{1} &= 3.18 \pm 0.70, \\
        P_{2} &= 11.70 \pm 2.46, \\
